...
#This is a library that builds the network and defines how to do gradient ascent
#deepdream.py calls the library to actually do it
...
def deepdream(net, base_img, iter_n=10, octave_n=4, octave_scale=1.4,
    ...
    octaves = [preprocess(net, base_img)]*4
